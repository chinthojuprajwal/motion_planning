    ...
    for count=1:4
        ...
        it=i;jt=j;
            if true
                ...
                if map(sub2ind(size(map),it+i1,jt+j1))==1 || map(sub2ind(size(map),it+i1,jt+j1))==6
                    map(sub2ind(size(map),it+i1,jt+j1))=4;
                    distances(sub2ind(size(map),it+i1,jt+j1))=min_dist+1;
                    parent(it+i1,jt+j1)=current;
                end
            end
    end
    % *******************************************************************
